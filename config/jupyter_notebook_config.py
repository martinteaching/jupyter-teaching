...
#  password.
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$Sis/q6PEQ656RVp/eI560Q$31DoO6iTYhfBfYSxXrhdq72sW2NqXLCnpBEtmvXLb98'
...
#  Choices: any of ['sha224', 'sha3_384', 'sha512', 'blake2s', 'sha1', 'sha256', 'blake2b', 'sha3_256', 'sha3_512', 'sha3_224', 'sha384', 'md5']
#  Default: 'sha256'
