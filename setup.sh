...
./copy.sh "jupyter_notebook_config.py" "/usr/local/etc/jupyter"
./copy.sh "overrides.json" "/usr/local/share/jupyter/lab/settings"
./copy.sh "page_config.json" "/usr/local/etc/jupyter/labconfig"
# ---------------------------------------------- #
